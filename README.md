...
Два общих модуля:
    ...
    :resources - модуль с ресурсами Android, платформозависимыми компонентами
...
==
Для работы необходимо задать Yandex api key ключ в модуле :remote-repository / gradle.properties или в общем файле настроек
